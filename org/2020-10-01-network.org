...
* protocol
官方规则或体系，用于统治或外交。衍生到网络，则是常见的C/S通讯模式，C/S不限于物理实体，也可以是同台电脑的两个进程通讯
** TCP
*** performance
**** handshake
...
***** A
0 net(7bit) host[24bit]
***** B
10 net(14bit) host[16bit]
***** C
110 net(21bit) host[8bit]
***** D
1110 multicast address[28bit]
***** E
1111 reserved address[28bit]
**** subnet address
